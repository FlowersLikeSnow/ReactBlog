...
`&&d&&!f&&k(1e4),c.current.push(setTimeout(g,j.current))}else t()};g()}),N=()=>new Promise(t=>{r(!0),d&&n.current&&s.current&&k(m(!0)),t()}),C=async()=>{var t;await S(0),await L(),await S(1),await N(),await S(2),a.current&&((t=a.current)==null||t.playMusic()),d&&k(1e4),c.current=[]},I=()=>{var t,l,u;c.current.length&&(c.current.forEach(g=>clearTimeout(g)),c.current=[]),v.map(g=>i.current+=g),x.current=y,r(!0),n.current&&((t=n.current)==null||t.goBottom()),s.current&&((l=s.current)==null||l.goBottom()),a.current&&((u=a.current)==null||u.playMusic()),d&&k(1e4)},_=t=>{c.current.length&&t?c.current.forEach(l=>clearTimeout(l)):C()};return e.useEffect(M,[]),window.addEventListener("resize",U(M,100),!1),o.jsxs("div",{className:"h-full w-full overflow-y-auto current-page",ref:p,children:[o.jsx(G,{updateSpeed:t=>j.current=t,speed:j.current}),o.jsxs("div",{className:"main",children:[o.jsx(q,{styleCode:i.current,setStyleCode:t=>{i.current=t,h(()=>t)},ref:s}),o.jsx(W,{markdown:x.current,showHTML:f,ref:n})]}),o.jsx(Z,{ref:a,onSkip:I,onPaused:_})]})};export{O as default};
